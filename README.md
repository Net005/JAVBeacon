...
```bash
docker pull ghcr.io/net005/javbeacon:1.0.3
docker pull ghcr.io/net005/javbeacon:latest
```

Published tags include `v1.0.3`, `1.0.3`, `1.0`, and `latest`. See the
...
docker build --build-arg VERSION=1.0.3 -t javbeacon:1.0.3 .
...
`VERSION=1.0.3` is released as `v1.0.3`.
