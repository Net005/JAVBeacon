...
```bash
docker pull ghcr.io/net005/javbeacon:1.0.16
docker pull ghcr.io/net005/javbeacon:latest
```

Published tags include `v1.0.16`, `1.0.16`, `1.0`, and `latest`. See the
...
docker build --build-arg VERSION=1.0.16 -t javbeacon:1.0.16 .
...
`VERSION=1.0.16` is released as `v1.0.16`.
