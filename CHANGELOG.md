...
Add future changes here under `Added`, `Changed`, `Fixed`, `Deprecated`,
`Removed`, or `Security`. When releasing, rename this section to the new
version and date, then add a fresh empty `Unreleased` section above it.
...
[Unreleased]: https://github.com/Net005/JAVBeacon/compare/v1.0.7...HEAD
