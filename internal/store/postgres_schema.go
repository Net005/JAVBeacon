...
CREATE TABLE IF NOT EXISTS releases (
	...
	ignore_download_history INTEGER NOT NULL DEFAULT 0,
	download_method_override TEXT NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS release_upgrade_runs (
	id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	started_at TIMESTAMPTZ NOT NULL,
	finished_at TIMESTAMPTZ NOT NULL,
	checked INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS downloads (
	...
	restored_parent_id TEXT NOT NULL DEFAULT '',
	restored_file_owned INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS stash_history_scenes (
...
func (s *SQLite) migratePostgres(ctx context.Context, report MigrationProgressFunc) error {
	...
	for _, statement := range []string{
		...
		`ALTER TABLE releases ADD COLUMN IF NOT EXISTS ignore_download_history INTEGER NOT NULL DEFAULT 0`,
		...
		`ALTER TABLE downloads ADD COLUMN IF NOT EXISTS restored_parent_id TEXT NOT NULL DEFAULT ''`,
		`ALTER TABLE downloads ADD COLUMN IF NOT EXISTS restored_file_owned INTEGER NOT NULL DEFAULT 0`,
