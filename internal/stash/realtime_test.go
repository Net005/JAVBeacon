...
func TestRealtimeSceneSyncUpdatesOnlyMatchedReleaseAndHistory(t *testing.T) {
	...
	svc.client.Transport = roundTripFunc(func(r *http.Request) (*http.Response, error) {
		...
		body := `{"data":{"findScene":{"id":"scene-123","title":"ABC-123 title","code":"ABC-123","date":"2024-01-02","created_at":"2024-01-03T04:05:06Z","urls":[],"o_counter":1,"play_count":1,"last_played_at":"2024-01-04T00:00:00Z","play_duration":120,"play_history":["2024-01-04T00:00:00Z"],"o_history":["2024-01-04T00:01:00Z"],"files":[{"path":"/library/ABC-123.mp4"}]}}}`
		return &http.Response{StatusCode: 200, Body: io.NopCloser(strings.NewReader(body)), Header: make(http.Header)}, nil
	})
	matched, err := svc.syncRealtimeScene(ctx, map[string]string{"stash_base_url": "https://stash.example"}, "scene-123")
	if err != nil {
		t.Fatal(err)
	}
	if matched != "ABC-123" {
	...
	if !got.Local || got.StashSceneID != "scene-123" || got.StashFilePath != "/library/ABC-123.mp4" || got.PlayCount != 1 || got.OCounter != 1 {
